...
const rootReducer = combineReducers({ loading, authorization, hero, listLodge, readLodge, readRoom })

export function* rootSaga() {
  yield all([authorizationSaga(), heroSaga(), listLodgeSaga(), readLodgeSaga(), readRoomSaga()])
}
