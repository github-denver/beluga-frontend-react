...
const Register = ({ history }) => {
  // console.log('containers → [Register.js] → history: ', history)

  const [message, setMessage] = useState(null)

  // const { form, authorization, error, user } = useSelector(({ authorization, user }) => {
  const { form, authorization, error } = useSelector(({ authorization, user }) => {
    ...
    // console.log('containers → [Register.js] → user: ', user)
    // console.log('')
  ...
  // console.log('containers → [Register.js] → form: ', form)
  // console.log('containers → [Register.js] → authorization: ', authorization)
  ...
  const onSubmit = (event) => {
    ...
    // console.log('containers → [Register.js] → id: ', id)
    // console.log('containers → [Register.js] → name: ', name)
    // console.log('containers → [Register.js] → password: ', password)
    // console.log('containers → [Register.js] → confirm: ', confirm)
    // console.log('')
  ...
  useEffect(() => {
    if (user) {
      // console.log('containers → [Register.js] → check API 성공')
      // console.log('containers → [Register.js] → user: ', user)
      // console.log('')
